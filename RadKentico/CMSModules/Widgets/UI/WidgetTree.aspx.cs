...
public partial class CMSModules_Widgets_UI_WidgetTree : SiteManagerPage, IPostBackEventHandler
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string deleteScript = "function DeleteItem() { \n" +
                              ...
                              "   var message = (selectedItemType == 'widgetcategory') ? " + ScriptHelper.GetString(GetString("widgets.deletecategoryconfirm")) + " : " + ScriptHelper.GetString(GetString("widgets.deleteconfirm")) + ";" +
                              "   if (confirm(message)) {\n " +
