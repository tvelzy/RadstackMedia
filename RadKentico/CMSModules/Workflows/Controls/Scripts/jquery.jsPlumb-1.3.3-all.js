            ...
            if (!self._jsPlumb.currentlyDragging) { //CMS EDIT - keeps UI from flashing
                ...
                if(!ignoreAttachedElements){
                    if(hover) {
                        ...
                        $j(self.canvas).addClass(self._jsPlumb.hoverClass);
                        if(self.tooltip) {
                            $j(self.canvas).tooltip().show();
                        }
                    } else {
                        this._jsPlumb.hoverItem = null;
                        $j(self.canvas).removeClass(self._jsPlumb.hoverClass);
                        if(self.tooltip) {
        ...
        this.paint = function(d, style, anchor) {
            if (style != null) {				
                ...
                if (self.canvas == null) {										
                    ...
                    $j(self.canvas).mousedown(function (self) { return function () { self.mouseDown(); } }(self))
